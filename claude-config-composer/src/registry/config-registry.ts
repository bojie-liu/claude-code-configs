    ...
    const registry: ConfigMetadata[] = [
      {
        id: 'nextjs-16',
        name: 'Next.js 16',
        description: 'Next.js 16 with Turbopack, Cache Components, React 19.2, and React Compiler',
        version: '16.0.0',
        category: 'framework',
        path: path.join(this.configsPath, 'frameworks', 'nextjs-16'),
        priority: 10,
        sections: [
          { title: 'Project Context', mergeable: true, priority: 10 },
          { title: 'Critical Next.js 16 Changes', mergeable: false, priority: 15 },
      ...
      },
      {
        id: 'shadcn',
        name: 'shadcn/ui 2025',
        description: 'Beautiful, accessible components with Radix UI, Tailwind v4, React 19, and enhanced CLI',
        version: '2.0.0',
        category: 'ui',
      ...
      },
      {
        ...
        description: 'Streaming AI applications with workflows, agents, enhanced providers, and AI SDK v5 features',
        version: '5.0.0',
        category: 'tooling',
      ...
      {
        id: 'drizzle',
        name: 'Drizzle ORM v0.44.6+',
        description: 'Type-safe database operations with identity columns, PostgreSQL 17, and enhanced DDL',
        version: '0.44.6',
        category: 'database',
      ...
      },
      {
        ...
        description: 'Utility-first CSS framework with CSS-first configuration, OKLCH colors, and high-performance engine',
        version: '4.0.0',
        category: 'ui',
